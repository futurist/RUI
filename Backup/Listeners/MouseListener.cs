...
namespace RUI.Listeners
{
    ...
    class MouseListener
    {
        ...
        {            
            ...
            {                
                ...
                MouseButtonEventArgs MouseButtonInfo = new MouseButtonEventArgs(MouseButtons.Left, MouseButtonState.Pressed, DateTime.Now);
            ...
            {                
                MouseButtonEventArgs MouseButtonInfo = new MouseButtonEventArgs(MouseButtons.Right, MouseButtonState.Pressed, DateTime.Now);
            ...
            {               
                MouseMoveEventArgs MouseMoveInfo = new MouseMoveEventArgs(Control.MousePosition.X, Control.MousePosition.Y, DateTime.Now);
    ...
    {
        public MouseMoveEventArgs(int X, int Y, DateTime now)
        {
            this.X = X;
            this.Y = Y;
            CurrentTime = now;
    ...
    {
        public MouseButtonEventArgs(MouseButtons Button, MouseButtonState buttonState, DateTime now)
        {
            CurrentTime = now;
            this.Button = Button;

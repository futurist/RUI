...
namespace RUI.Replay
{
    class RUIReplayer
    {
                ...
                do
                {
                    ...
                    if (buf != null && buf != "")
                    {
                        ...
                        if (sleepTimeMod == 0)
                            ...
                            Thread.Sleep(System.Convert.ToInt32(sleeptime * 0.05));
        ...
        public long GetSleepTime(string extractTime, int turn)
        {
            ...
            try
            {
                Console.WriteLine(extractTime);
                totalMilliseconds = System.Convert.ToInt32(System.Convert.ToDecimal(extractTime) * 1000);

                if (totalMilliseconds > globalvar.oldTime)
                {
                    sleepTime = totalMilliseconds - globalvar.oldTime;
                }
                else
                {
                    sleepTime = 0;

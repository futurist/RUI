...
namespace RUI.Listeners
{
    ...
    class MouseListener
    {
        ...
        {            
            ...
            {                
                ...
                MouseButtonEventArgs MouseButtonInfo = new MouseButtonEventArgs(MouseButtons.Left, MouseButtonState.Pressed, DateTime.Now, Control.MousePosition.X, Control.MousePosition.Y);
    ...
    {
        public MouseButtonEventArgs(MouseButtons Button, MouseButtonState buttonState, DateTime now, int X, int Y)
        {
            CurrentTime = now;
            this.Button = Button;
